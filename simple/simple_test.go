...
/* Board Test Cases */
func Test1x1EmptyBoard(t *testing.T) {
	expected := int32(0)
...
func Test9x9EmptyBoard(t *testing.T) {
	expected := int32(32)
...
func Test3x3EmptyBoard(t *testing.T) {
	expected := int32(8)
...
func Test4x4EmptyBoard(t *testing.T) {
	expected := int32(9)
...
func Test5x5EmptyBoard(t *testing.T) {
	expected := int32(14)
...
func Test100x100Board(t *testing.T) {
	expected := int32(40)
