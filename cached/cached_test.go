...
func TestCached1x1EmptyBoard(t *testing.T) {
	expected := int32(0)
...
func TestCached9x9EmptyBoard(t *testing.T) {
	expected := int32(32)
...
func TestCached3x3EmptyBoard(t *testing.T) {
	expected := int32(8)
...
func TestCached4x4EmptyBoard(t *testing.T) {
	expected := int32(9)
...
func TestCached5x5EmptyBoard(t *testing.T) {
	expected := int32(14)
...
func TestCached5x5Board(t *testing.T) {
	expected := int32(10)
...
func TestCached8x8Board(t *testing.T) {
	expected := int32(24)
...
func TestCached100x100Board(t *testing.T) {
	expected := int32(40)
